...
class BrandColors{
  ...
  static const Color editText = Color(0xFF94DB56);
  static const Color button = Color(0xFFF0E3E3);
  static const Color enterphonenumber = Color(0xFF689F38);
  static const Color signup = Color(0xFF2E59E8);
